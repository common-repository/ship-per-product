...
if ($activated)
{
	...
	*/
	function ced_spp_doc_settings( $actions, $plugin_file )
	{
		...
		{
			$settings = array('settings' => '<a href="'.admin_url('admin.php?page=wc-settings&tab=shipping&section=ced_pps').'">' . __('Settings', 'ship-per-product') . '</a>');
